...
//	}
	...
	public void testBasic () {
		assertEquals(2.0, MVEL.eval("Math.sin(Math.PI/2) * 2 + Math.cos(Math.PI/2) * 2"));
		assertEquals(2.0, MVEL.executeExpression(MVEL.compileExpression("Math.sin(Math.PI/2) * 2 + Math.cos(Math.PI/2) * 2")));
	}
}