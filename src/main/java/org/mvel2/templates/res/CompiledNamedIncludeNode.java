...
public class CompiledNamedIncludeNode extends Node {
  ...
  @Override
    ...
    if (next != null) {
      ...
      return next.eval(runtime, append(appender, TemplateRuntime.execute(ct, ctx, factory, runtime.getNamedTemplateRegistry())), ctx, factory);
...
//                    appender.append(String.valueOf(TemplateRuntime.execute(runtime.getNamedTemplateRegistry().getNamedTemplate(MVEL.executeExpression(cIncludeExpression, ctx, factory, String.class)), ctx, factory))), ctx, factory);
      ...
      return append(appender, TemplateRuntime.execute(runtime.getNamedTemplateRegistry().getNamedTemplate(
					MVEL.executeExpression(cIncludeExpression, ctx, factory, String.class)),
					ctx,
					factory,
